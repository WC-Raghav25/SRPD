    ...
    <div className="fixed inset-0 z-50 bg-black/40 flex items-end sm:items-center justify-center">
      <div className="bg-white w-full sm:max-w-sm sm:rounded-2xl rounded-t-2xl p-5 max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex flex-col gap-3">
          ...
          <label className="text-xs font-semibold text-slate-500">Photo (emoji or image URL)</label>
          <input value={form.image} onChange={e => setForm({ ...form, image: e.target.value })}
            className="border border-slate-200 rounded-xl px-4 py-3 text-base outline-none focus:border-amber-500" placeholder="📓 or https://…" />
